...
func TestValidateURL(t *testing.T) {
	tests := []struct {
		...
		{"Blocked port 8080", "http://example.com:8080", false, true},
		{"Blocked port 1433 (MSSQL)", "http://example.com:1433", false, true},
		{"Blocked port 5900 (VNC)", "http://example.com:5900", false, true},
