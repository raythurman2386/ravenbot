...
Please report security vulnerabilities by emailing [INSERT CONTACT EMAIL] or by creating a **private** vulnerability report on GitHub if enabled.
...
4.  **Review MCP Permissions**: Be careful when adding new MCP servers that have filesystem or network access.
